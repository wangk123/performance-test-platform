  ...
  routes: [
    { path: '/login', name: 'login', component: AuthScreen },
    {
      ...
      children: [
        ...
        { path: 'projects/:projectId/tasks', name: 'project-tasks', component: ProjectDetail },
        { path: 'projects/:projectId/tasks/:taskId', name: 'project-task-detail', component: ProjectDetail },
